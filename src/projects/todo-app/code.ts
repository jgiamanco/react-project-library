...
const TodoApp = () => {
  ...
  return (
    <div className={\`min-h-screen p-4 \${darkMode ? 'dark bg-gray-900' : 'bg-gray-100'}\`}>
      <Card className={\`mx-auto max-w-md \${darkMode ? 'bg-gray-800 text-white' : ''}\`}>
        <CardHeader>
                          ...
                          >
                            <div className="flex items-center">
                              <Button
                                variant="ghost"
                                size="icon"
                                className={\`mr-2 \${todo.completed ? 'text-green-500' : ''}\`}
                                onClick={() => toggleTodo(todo.id)}
                              >
                                <Check className={\`h-5 w-5 \${!todo.completed && 'opacity-0'}\`} />
                              </Button>
